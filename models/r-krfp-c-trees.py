...
# Average CV score on the training set was: 0.8557161638000501
exported_pipeline = make_pipeline(
    make_union(
        FunctionTransformer(copy),
        FunctionTransformer(copy)
    ),
    ExtraTreesClassifier(bootstrap=True, criterion="entropy", max_depth=20, max_features=0.9000000000000001, max_samples=None, min_samples_leaf=1, min_samples_split=18, n_estimators=50)
)
